...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        action_savesql = new QAction(MainWindow);
        ...
        menu_file->addAction(action_savesql);
